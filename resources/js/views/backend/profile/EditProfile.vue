<template>
    <div>
        <form @submit.prevent="updateProfile">
            <span class="text-xl vazir-bold">اطلاعات حساب کاربری</span>
            <div class="my-3">
            ...
            <div class="my-3" v-if="store.state.dashboard.data.is_vip">
            ...
            <div class="my-3">
                <div class="flex items-center justify-between gap-5">
                    <div class="flex-1" v-if="store.state.dashboard.data.is_vip">
...
<script setup>
    ...
    const user = store.state.dashboard.data;
    ...
    let userData = ref(store.state.dashboard.data.is_vip ? {
        id: user.id,
        name: user.name,
        last_name: user.last_name,
        birthday: JSON.parse(user.birthday) ??  {year: '', mount: '', day: ''},
        national_code: user.national_code,
        email: user.email,
        company: user.company,
        image: '',
        image_address: user.image,
        company_registration_number: user.company_registration_number,
        company_type:  JSON.parse(user.company_type) ?? { generative: false, services: false, commercial: false },
        state: user.state,
        city: user.city,
        company_exact_address: user.company_exact_address,
    ...
    let updateProfile = () => {
        ...
        store.dispatch(store.state.dashboard.data.is_vip ? 'updateVIPUser' : 'updateUser', userData.value)
            .then(res => {
